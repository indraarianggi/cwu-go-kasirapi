        ...
        "/api/report": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Start date (yyyy-MM-dd format, e.g., 2026-01-01). If omitted, includes all transactions from the beginning.",
                        "name": "start_date",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "End date (yyyy-MM-dd format, e.g., 2026-01-31). If omitted, includes all transactions up to now.",
                        "name": "end_date",
                        "in": "query"
                    }
                ],
